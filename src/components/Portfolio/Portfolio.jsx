    ...
    <section id="portfolio" ref={sectionRef} className="portfolio">
      <div className="portfolio__container">
        ...
        <h2 className="portfolio__heading">
          Trabalhos em <span className="portfolio__heading--accent">destaque</span>
        </h2>

        {works.map((work, idx) => (
          <article key={work.id} className={`work-card ${idx % 2 !== 0 ? 'work-card--reverse' : ''}`}>
